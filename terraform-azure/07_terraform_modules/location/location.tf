...
resource "azurerm_subnet_network_security_group_association" "web_server_nsg_sga" {
  network_security_group_id = azurerm_network_security_group.web_server_nsg.id
  subnet_id                 = azurerm_subnet.web_server_subnet["web-server-subnet"].id
}
...
resource "azurerm_lb" "web_serber_lb" {
...
resource "azurerm_lb_backend_address_pool" "web_server_lb_backend_pool" {
  ...
  resource_group_name = azurerm_resource_group.web_server_rg.name
  loadbalancer_id     = azurerm_lb.web_serber_lb.id
}
